    ...
    return (
        <main className={style.main}>
            ...
            <div className={style.divMultMedia}>
                <Buttom type='music' icone={<img src={iconePlus} width={"25px"} style={{ cursor: "pointer" }} alt="Adicionar a playlist" />} />
                <Buttom type='music' icone={<img src={iconePlay} width={"25px"} style={{ cursor: "pointer" }} alt="Play" />} />
                <Buttom type='music' icone={<img src={iconeDeezer} width={"23px"} style={{ cursor: "pointer" }} alt="Tocando" />} />
            </div>
        </main>
    )
}
